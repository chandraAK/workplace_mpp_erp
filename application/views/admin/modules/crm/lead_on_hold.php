...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Lead On Hold</h3>
            <?php require_once(APPPATH."views/admin/breadcrumb.php"); ?>
        </div> 
    </div>

    <!--- Form Starts -->
    <form action="<?php echo base_url(); ?>index.php/crmc/lead_on_hold_entry" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-2"><b>Lead Hold Remarks</b></div>
        <div class="col-lg-4">
            <textarea id="lead_hold_rmks" name="lead_hold_rmks" class="form-control"></textarea>
        </div>
