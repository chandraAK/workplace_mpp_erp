...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Initiation For Facility Visit</h3>
            <?php require_once(APPPATH."views/admin/breadcrumb.php"); ?>
        </div> 
    </div>

    <!--- Form Starts -->
    <form action="<?php echo base_url(); ?>index.php/crmc/quote_iffv_entry" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-2"><b>Initiation Facility Visit Remarks</b></div>
        <div class="col-lg-2">
            <textarea id="quote_iffv_rmks" name="quote_iffv_rmks" class="form-control"></textarea>
        </div>
        <div class="col-lg-4"></div>
    </div><br><br>
