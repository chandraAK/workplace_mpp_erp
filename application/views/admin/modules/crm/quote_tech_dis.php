...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Techincal Discussion</h3>
            <?php require_once(APPPATH."views/admin/breadcrumb.php"); ?>
        </div> 
    </div>

    <!--- Form Starts -->
    <form action="<?php echo base_url(); ?>index.php/crmc/quote_tech_dis_entry" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-2"><b>Technical Discussion Remarks</b></div>
        <div class="col-lg-2">
            <textarea id="tech_dis_rmks" name="tech_dis_rmks" class="form-control"></textarea>
        </div>
        <div class="col-lg-4"></div>
    </div><br><br>
