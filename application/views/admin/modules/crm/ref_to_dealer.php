...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Refer To Dealer</h3>
            <?php require_once(APPPATH."views/admin/breadcrumb.php"); ?>
        </div> 
    </div>

    <!--- Form Starts -->
    <form action="<?php echo base_url(); ?>index.php/crmc/ref_to_dealer_entry" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-2"><b>Refer To Dealer Remarks</b></div>
        <div class="col-lg-4">
            <textarea id="ref_to_dealer_rmks" name="ref_to_dealer_rmks" class="form-control"></textarea>
        </div>
