...
<section id="main-content">
  <section class="wrapper"> 
    ...
    <?php
        ...
        /* if($dr_id != ''){
            foreach($get_dept->result() as $row1){
                $dept = $row->dept;
            }
        } else {
            $dept = "";
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            <form class="form-horizontal " method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/drc/dr_entry_design">
            <div class="panel-body">
                <!-- Inquiry Details -->
                <?php
                    if($dr_id != ''){
                        echo "<h2>DR No-".$dr_id." Dept".$dept."</h2>";
                ?>
