...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Attendance Card MPP</h3>
    ...
    <div class="row" style="text-align:center">
    	...
    	<div class="col-lg-2"><select id="att_month" name="att_month" class="form-control"><?php echo month_mpp();?></select></div>
    	<div class="col-lg-1"><b>Year:</b></div>
        <div class="col-lg-2"><select id="att_year" name="att_year" class="form-control"><?php echo year_mpp();?></select></div>
        <div class="col-lg-1"><b>Card No:</b></div>
        <div class="col-lg-2"><select id="card_no" name="card_no" class="form-control"><?php echo CardNoMpp();?></select></div>
...
function filter(){
    ...
    xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/Att_Card_Mpp_Ajax" + queryString,true);
    xmlhttp.send();
}
