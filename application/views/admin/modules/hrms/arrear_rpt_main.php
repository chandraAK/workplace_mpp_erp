...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Arrear Report</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <div class="col-lg-2">
            <select id="status" name="status" class="form-control">
                ...
                <?php
                    $sql_stat = "select distinct status from arrear";
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="<?php echo base_url(); ?>index.php/hrmsc/arrear_add?id=">
...
function filter(){
    ...
    xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/arrear_rpt_ajax" + queryString,true);
    xmlhttp.send();
}
