...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Attendence Report New</h3>
    ...
    <!-- Ajax Response Div -->
    <h3>Attendence Date : <?=date("Y-m-d",strtotime("-1 days")); ?></h3>
...
<script type="text/javascript">
    ...
    function filter(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/att_rpt_new_ajax" + queryString,true);
        xmlhttp.send();
    }
</script>
