...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Deductions Add</h3>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                    <?php if($status == "Pending For Management Approval"){ ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/ded_app_mng">
                    <?php } else { ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/ded_entry" onsubmit="return reqd();">
                    <?php } ?>
                        <input type="hidden" class="form-control" id="ded_id" name="ded_id[]" value="<?php echo $ded_id; ?>">
                <div class="form-group">
                    <div class="col-sm-6" style="text-align:left">
                        <?php
                            if($ded_id != ''){
                                echo "<b style='font-size:18px'>Deduction No-".$ded_id."</b>";
                            }
                        ?>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label">Deduction Amount</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="ded_amt" name="ded_amt" value="<?=$ded_amt;?>" autocomplete="off" required onkeypress="return isNumberKey(event);">
                    </div>  
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <textarea type="text" class="form-control" id="ded_rmks" name="ded_rmks" autocomplete="off" required><?=$ded_rmks;?></textarea>
                    </div>  
                </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
                $sql = "select * from deductions where ded_id = '".$ded_id."'";
...
<script>
function reqd(){
    var ded_amt = document.getElementById("ded_amt").value;
