...
<div class="row">
    <div class="col-lg-12">
        <table class="table table-bordered" id="example1" style="margin-top:60px">
            ...
            <tbody>
                <?php
                    $sql_emp = "select * from deductions 
                ...
                <tr>
                    <td><?php if($status != "Approved"){?><input type="checkbox" id="ded_id" name="ded_id[]" value="<?=$ded_id;?>"><?php } ?></td>
                    <td><?=$ded_id;?></td>
                    <td><?=$emp_id;?></td>
                    <td><?=$employee_name;?></td>
                    <td><?=$department;?></td>
