...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Early Exit Script</h3>
            <?php require_once(APPPATH."views/admin/breadcrumb.php"); ?>
        </div> 
    </div>

    <div class="row">
        <div class="col-lg-2"><b>Early Exit Script Date:<b></div>
        <div class="col-lg-2"><input type="text" id="from_dt" name="from_dt" value="<?=$from_dt; ?>" class="form-control"></div>
        <div class="col-lg-2"><input type="button" id="filter" name="filter" value="Get Early Exit" class="form-control" onClick="filter()"></div>
...
<script type="text/javascript">
    ...
    function filter(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/early_exit_script_ajax" + queryString,true);
        xmlhttp.send();
    }
    ...
    function trigger_mail(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/early_exit_script_mail" + queryString,true);
        xmlhttp.send();
    }
</script>
