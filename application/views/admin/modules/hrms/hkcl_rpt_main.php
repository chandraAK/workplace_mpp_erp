...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Housekeeping & Construction Labour DR Report</h3>
...
<script type="text/javascript">
    ...
    function filter(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/hkcl_rpt_ajax" + queryString,true);
        xmlhttp.send();
    }
</script>