...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Leave Balance Report</h3>
...
<script type="text/javascript">
    ...
    function filter(){
        ...
        var queryString="?att_year="+encodeURIComponent(att_year);
        
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/lv_bal_rpt_ajax" + queryString,true);
        xmlhttp.send();
    }
</script>
