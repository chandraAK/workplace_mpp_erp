...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Mail Script</h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-2"><input type="button" id="filter" name="filter" value="Submit" class="form-control" onClick="filter()"></div>
        <div class="col-lg-2"><button class="form-control" onClick="trigger_mail()"><i class="fa fa-envelope"></i> Send Mail HR</button></div>
        <div class="col-lg-2"><button class="form-control" onClick="trigger_mail_ra()"><i class="fa fa-envelope"></i> Send Mail RA</button></div>
...
<script type="text/javascript">
    ...
    function filter(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/mail_script_ajax" + queryString,true);
        xmlhttp.send();
    }


    //Ajax To Send Mail HR
    function trigger_mail(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/mail_all" + queryString,true);
        xmlhttp.send();
    }

    //Ajax To Send Mail RA
    function trigger_mail_ra(){
        var from_dt = document.getElementById("from_dt").value;
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/mail_ra" + queryString,true);
        xmlhttp.send();
    }
</script>
