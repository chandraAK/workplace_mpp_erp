...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>MPP Production & Others Employees List</h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_emp_add?id=">
...
function filter(){
    ...
    var queryString="?type="+encodeURIComponent(type);
    
    xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_emp_rpt_ajax" + queryString,true);
    xmlhttp.send();
}
