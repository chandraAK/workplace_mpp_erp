    ...
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_sal_adv_entry">
                    
                <div class="form-group">
                    <label class="col-lg-1 control-label">Employee ID</label>
                    <div class="col-lg-3">
                        <select id="emp_id" name="emp_id" required>
                            <option value="" selected disabled>--Select--</option>
                            <?php
                                $sql_emp = "select * from mpp_prod_oth_emp_mst";
                                $qry_emp = $this->db->query($sql_emp);
                                foreach($qry_emp->result() as $row){
                                    $emp_id = $row->emp_id;
                                    $emp_name = $row->emp_name;
                            ?>
                                <option value="<?=$emp_id;?>"><?=$emp_id." - ".$emp_name;?></option>
                            <?php
                                }
                            ?>
                        </select>
                    ...
                    <label class="col-lg-1 control-label">Advance Required</label>
                    <div class="col-lg-3">
                        <input type="text" class="form-control" id="sal_adv_req" name="sal_adv_req" value="" autocomplete="off" required onkeypress="return isNumberKey(event);">
                    </div> 
