...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>MPP Production Salary Advance Report</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <div class="col-lg-2">
            <select id="status" name="status" class="form-control">
                ...
                <?php
                    $sql_stat = "select distinct status from salary_adv_mpp_prod";
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_sal_adv_add?id=">
...
function filter(){
    ...
    xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_sal_adv_rpt_ajax" + queryString,true);
    xmlhttp.send();
}
