...
<?php if($status == "Pending For HR Approval"){ ?>
    <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_sa_app_hr">
<?php } elseif($status == "Pending For Management Approval"){ ?>
    <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_sa_app_mng">
<?php } elseif($status == "Pending For Payment" || $status == "Unpaid"){ ?>
    <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/mpp_prod_sa_app_pay">
...
<div class="row">
    <div class="col-lg-12">
        <table class="table table-bordered" id="example1" style="margin-top:60px">
            ...
            <tbody>
                <?php
                    $sql_emp = "select * from salary_adv_mpp_prod 
                    ...
                    foreach($qry_emp->result() as $row){
                        ...
                        $sql_emp_name = "select * from mpp_prod_oth_emp_mst where emp_id = '$emp_id'";
