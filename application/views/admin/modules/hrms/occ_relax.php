...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Occassional Relaxation</h3>
    ...
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/occ_relax_entry">
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">Relaxation Time (Minutes)</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">Number Of Times In A Month</label>
                        <div class="col-sm-3">
                            <input type="text" id="relax_notm" name="relax_notm" class="form-control" required onkeypress="return isNumberKey(event);">
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM `occ_relax` order by created_date desc";
                    ...
                    <tr>
                        ...
                        <td><?=$row->relax_app_date;?></td>
                        <td><?=$row->relax_notm;?></td>
