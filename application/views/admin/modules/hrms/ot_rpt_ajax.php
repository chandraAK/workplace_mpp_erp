...
<?php
    ...
    if($status == 'All'){
        ...
        $where_str .= " and ot_status = '".$status."'";
    }

    if($role == 'Admin'){
        $where_str .= "";
    } else {
        $where_str .= " and ot_reports_to = '".$emp_id1."'";
    }

    if($comp == 'All'){
        $where_str .= "";
    } else {
        $where_str .= " and ot_emp_id in(select distinct emp_id from emp_rep_to_mst where branch = '".$comp."')";
    }
?>
        ...
        <table class="table table-bordered" id="example1" style="margin-top:60px">
            <thead>
                <tr>
                    ...
                    <th><b>Overtime ID</b></th>
                    <th><b>Employee ID</b></th>
                    <th><b>Employee Name</b></th>
                    <th><b>Department</b></th>
                    <th><b>Reports To</b></th>
                    <th><b>Employee Type</b></th>
                    <th><b>Overtime From DateTime</b></th>
                    <th><b>Overtime To DateTime</b></th>
                    <th><b>Overtime Hours</b></th>
                    <th><b>Overtime Status</b></th>
                    <th><b>Remarks</b></th>
            ...
            <tbody>
                <?php
                    ...
                    foreach($qry_emp->result() as $row){
                        ...
                        $sql_emp_det = "select * from `tabEmployee` where name = '".$ot_emp_id."'";
                ...
                <tr>
                    <td><?php if($status != "Approved"){?><input type="checkbox" id="over_tim_id" name="over_tim_id[]" value="<?=$over_tim_id;?>"><?php } ?></td>
                    <td><a href="<?php echo base_url();?>index.php/hrmsc/over_time?id=<?=$over_tim_id;?>"><?=$over_tim_id;?></a></td>
                    <td><?=$ot_emp_id;?></td>
                    <td><?=$employee_name;?></td>
                    <td><?=$department;?></td>
                    <td><?=$reports_to;?></td>
                    <td><?=$employee_type;?></td>
                    <td><?=$ot_frm_date." ".$ot_frm_time;?></td>
                    <td><?=$ot_to_date." ".$ot_to_time;?></td>
                    <td><?=$ot_tot_hrs;?></td>
                    <td><?=$ot_status;?></td>
                    <td><?=$ot_remarks;?></td>
                    <td><?=$created_date;?></td>
