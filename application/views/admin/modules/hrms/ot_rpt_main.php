...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Overtime Report</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <div class="col-lg-2">
            <select id="status" name="status" class="form-control">
                ...
                <?php
                    $sql_stat = "select distinct ot_status from over_time";
...
function filter(){
    ...
    var queryString="?att_month="+encodeURIComponent(att_month)+"&att_year="+encodeURIComponent(att_year)+"&status="+encodeURIComponent(status)+"&comp="+encodeURIComponent(comp);
    
    xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/ot_rpt_ajax" + queryString,true);
    xmlhttp.send();
}
