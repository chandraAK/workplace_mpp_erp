...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Paper Blank Advance Add</h3>
    ...
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                    ...
                    <?php } else { ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/pb_sal_adv_entry" onsubmit="return reqd();">
                    <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select id="emp_id" name="emp_id" class="form-control" onchange="sal_adv_cal(this.value);" required>
                            ...
                            ?>
                            <?php
                                $sql_emp = "select name, employee_name from `tabWorker` where status = 'Active' order by name";
                                $qry_emp = $db2->query($sql_emp);
                                foreach($qry_emp->result() as $row){
                                    $emp_id = $row->name;
                                    $employee_name = $row->employee_name;
                            ?>
                                <option value="<?=$emp_id; ?>"><?php echo $emp_id." - ".$employee_name;?></option>
                            <?php
                                } 
                            ?>
                        </select>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
                $sql = "select * from salary_adv_pb where sal_adv_id = '".$sal_adv_id."'";
...
function sal_adv_cal(emp_id){
    ...
    $("#detail").empty().html('<img src="<?php echo base_url(); ?>assets/images/wait.gif" />');
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/pb_sal_adv_cal" + queryString,true);
        xmlhttp.send();
}
</script>
