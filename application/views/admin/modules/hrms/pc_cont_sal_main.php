...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Paper Cup Contract Salary</h3>
...
function filter(){
    ...
    var queryString="?att_month="+encodeURIComponent(att_month)+"&att_year="+encodeURIComponent(att_year)+"&emp_type="+encodeURIComponent(emp_type)+"&sal_type="+encodeURIComponent(sal_type);
    
    xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/pc_cont_sal_ajax" + queryString,true);
    xmlhttp.send();
}
