    ...
    <tbody>
        <tr>
            <td>
                ...
                where `tabPNI Packing`.date between '".$from_dt."' and '".$to_dt."'
                and `tabPNI Packing`.machine_helper_id = '".$emp_id."'
                ...
                where `tabPC Extra Contract Payment`.effective_date between '".$from_dt."' and '".$to_dt."'
                and `tabPC Wages`.employee = '".$emp_id."'";

                $qry_extra_pay = $db2->query($sql_extra_pay)->row();

                $extra_pay = $qry_extra_pay->extra_pay;

                echo $NetSalary = $prod_sal+$extra_pay;
