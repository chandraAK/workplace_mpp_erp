...
<div class="row">
    <div class="col-lg-12">
        <table class="table table-bordered" id="example1" style="margin-top:60px">
            ...
            <tbody>
                <?php
                    $sql_emp = "select * from salary_adv_pcpb 
                    ...
                    foreach($qry_emp->result() as $row){
                        ...
                        $employee_type = $qry_emp_det->employee_type;
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url();?>index.php/hrmsc/pcpb_sal_adv_add?id=<?=$sal_adv_id;?>"><?=$sal_adv_id;?></a></td>
                    <td><?=$emp_id;?></td>
                    <td><?=$employee_name;?></td>
                    <td><?=$department;?></td>
                    <td><?=$reports_to;?></td>
