...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Penalty Type2</h3>
...
<script type="text/javascript">
    ...
    function filter(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/penalty_type2_ajax" + queryString,true);
        xmlhttp.send();
    }
    ...
    function trigger_mail(){
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/penalty_type2_mail" + queryString,true);
        xmlhttp.send();
    }
</script>
