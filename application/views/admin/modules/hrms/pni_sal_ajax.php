...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <td style="font-weight:bold">PNI TYPE-1 ON</td>
                    ...
                    <td><?=cs_pni("NetPay", "payroll_mst_type1", $start_dt, $end_dt, "On Roll", "0", "PNI", $pay_status, "NetPay > 0");?></td>
                </tr>
                <tr>
                    <td style="font-weight:bold">PNI TYPE-2 ON</td>
                    ...
                    <td><?=cs_pni("NetPay", "payroll_mst_type2", $start_dt, $end_dt, "On Roll", "1", "PNI", $pay_status, "NetPay > 0");?></td>
                </tr>
                <tr>
                    <td style="font-weight:bold">PNI PAPER CUP ON</td>
                    ...
                    <td><?=cs_pni("NetPay", "payroll_mst_pc", $start_dt, $end_dt, "On Roll", "", "PNI", $pay_status, "NetPay > 0");?></td>
                </tr>
                <!--- Total --->
                <tr style="font-weight:bold; background-color:#b3d9ff">
                    <td>Total</td>
                    <td><?=cs_tot_pni("NetSalary", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("PF_Amt", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("esi_amt", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("tot_advance_amount", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("tot_spcl_advance_amount", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("tot_loan_amount", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("prev_ded", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("net_paybl_sal", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "net_paybl_sal < 0");?></td>
                    <td><?=cs_tot_pni("net_paybl_sal", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "net_paybl_sal > 0");?></td>
                    <td><?=cs_tot_pni("welfare", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "");?></td>
                    <td><?=cs_tot_pni("NetPay", $start_dt, $end_dt, "On Roll", "PNI", $pay_status, "NetPay > 0");?></td>
                </tr>
            </tbody>
        </table>
    </div>
