...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Salary Advance Application</h3>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                    <?php if($status == "Pending For HOD Approval"){ ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/sa_app_hod">
                    <?php }
                     else if($status == "Pending For HR Approval"){ ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/sa_app_hr">
                    <?php } elseif($status == "Pending For Management Approval"){ ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/sa_app_mng">
                    <?php } elseif($status == "Pending For Payment"){ ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/sa_app_pay">
                    <?php }  else if($status == "Approved"){ ?>
                        <!--Do Nothing-->
                        <form class="form-horizontal" id="myForm" method="post" action="">
                    <?php } else { ?>
                        <form class="form-horizontal" id="myForm" method="post" action="<?php echo base_url(); ?>index.php/hrmsc/sal_adv_entry" onsubmit="return reqd();">
                    <?php } ?>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
                $sql = "select * from salary_adv where sal_adv_id = '".$sal_adv_id."'";
...
function sal_adv_cal(emp_id){
    ...
    $("#detail").empty().html('<img src="<?php echo base_url(); ?>assets/images/wait.gif" />');
        ...
        xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/sal_adv_cal" + queryString,true);
        xmlhttp.send();
}
</script>
