...
<div class="row">
    <div class="col-lg-12">
        <table class="table table-bordered" id="example1" style="margin-top:60px">
            ...
            <tbody>
                <?php
                    $sql_emp = "select * from salary_adv 
                    ...
                    foreach($qry_emp->result() as $row){
                        ...
                        $custom_contractor_name = $qry_emp_det->custom_contractor_name;
                ?>

                <tr>
                    <td><?php if($status != "Paid"){?><input type="checkbox" id="sal_adv_id" name="sal_adv_id[]" value="<?=$sal_adv_id;?>"><?php } ?></td>
                    <td><a href="<?php echo base_url();?>index.php/hrmsc/sal_adv_add?id=<?=$sal_adv_id;?>"><?=$sal_adv_id;?></a></td>
                    <td><?=$branch; ?></td>
