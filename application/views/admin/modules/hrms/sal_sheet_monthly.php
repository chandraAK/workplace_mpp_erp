...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Salary Sheet Type-1</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <div class="col-lg-1"><b>Emp Type:</b></div>
        <div class="col-lg-2"><select id="emp_type" name="emp_type" class="form-control"><?php echo emp_type();?></select></div>
        <div class="col-lg-1"><b>Sal Type:</b></div>
        <div class="col-lg-2"><select id="sal_type" name="sal_type" class="form-control"><?php echo sal_type();?></select></div>
    </div><br>
...
function filter(){
    ...
    var queryString="?att_month="+encodeURIComponent(att_month)+"&att_year="+encodeURIComponent(att_year)+"&emp_type="+encodeURIComponent(emp_type)+"&sal_type="+encodeURIComponent(sal_type)+"&card_no="+encodeURIComponent(card_no);
    
    xmlhttp.open("GET","<?php echo base_url(); ?>index.php/hrmsc/sal_sheet_monthly_ajax" + queryString,true);
    xmlhttp.send();
}
