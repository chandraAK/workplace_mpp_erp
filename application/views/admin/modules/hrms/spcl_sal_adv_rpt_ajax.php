...
<?php } else if($status == "Pending For Payment" || $status == "Unpaid"){ ?>
...
<div class="row">
    <div class="col-lg-12">
        <table class="table table-bordered" id="example1" style="margin-top:60px">
            ...
            <tbody>
                <?php
                    $sql_emp = "select * from spcl_salary_adv 
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url();?>index.php/hrmsc/spcl_sal_adv_add?id=<?=$sal_adv_id;?>"><?=$sal_adv_id;?></a></td>
                    <td><?=$emp_id;?></td>
                    <td><?=$employee_name;?></td>
                    <td><?=$department;?></td>
                    <td><?=$reports_to;?></td>
