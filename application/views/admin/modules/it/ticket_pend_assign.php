<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Ticket Assignment</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/itc/ticket_pend_assign_entry">
                <?php include("ticket_details_div.php"); ?>

                <div class="form-group">
                    <label class="col-sm-2 control-label"  style="text-align:left">Ticket Assign To</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea id="ticket_rmks_assign" name="ticket_rmks_assign" class="form-control"></textarea>
                    </div>
                </div>
                <?php 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="submit" class="form-control" id="assign" name="assign" value="Assign">
                    </div>
                    <div class="col-sm-5"></div>
                </div>
