...
<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Production Form</h3>
    ...
    <?php
        ...
        if($chhilai_id != ''){
            foreach($get_chhilai_by_id->result() as $row){
    ...
    <div class="row" style="text-align:center">
        ...
        <div class="col-lg-8">
        <section class="panel">
            <header class="panel-heading">Production Form</header>
            
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/productionc/chhilai_entry_bm">
            <div class="panel-body">
                <!-- Inquiry Details -->
                <?php
                    if($chhilai_id != ''){
                        echo "<h2>Chhilai Id :- ".$chhilai_id."</h2>";
                ?>
                ...
                <input type="hidden" id="comp_id" name="comp_id" value="3">
