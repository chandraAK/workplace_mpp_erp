  ...
  <section class="wrapper"> 
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            ?>
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/projectsc/proj_mr_appl2_entry">
                <?php
                    if($mr_id != ''){
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="submit" class="form-control" id="submit" name="submit" value="Approve Material Request L2">
                    </div>
                    <div class="col-sm-4"></div>
                </div>
            </form>
