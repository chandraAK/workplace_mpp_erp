<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Submit Final Quotation Form</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            ?>
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/projectsc/proj_quote_acc_sfq_entry">
                <?php
                    if($quote_id != ''){
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Requested Token Money Amount</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="quote_rtma" name="quote_rtma" 
                        value="<?php if($quote_id != ''){ echo $quote_rtma; } else { echo ""; }?>" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="submit" class="form-control" id="submit" name="submit" value="Submit Final Quote">
                    </div>
                    <div class="col-sm-4"></div>
                </div>
            </form>
