  ...
  <section class="wrapper"> 
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            ?>
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/projectsc/proj_quote_rej_di_entry">
                <?php
                    if($quote_id != ''){
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="submit" class="form-control" id="submit" name="submit" value="Drop Inquiry">
                    </div>
                    <div class="col-sm-5"></div>
                </div>
            </form>
