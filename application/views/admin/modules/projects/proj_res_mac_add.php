<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Add Machines</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            <?php
                if($mac_id != ''){
                    echo "<h2>Machine Id - ".$mac_id."</h2>";
                }
            ?>
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/projectsc/proj_res_mac_entry">
                <div class="form-group">
                    <label class="col-sm-2 control-label">Machine Name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pr_mac_name" name="pr_mac_name" value="" required>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label">Machine Desc</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pr_mac_desc" name="pr_mac_desc" value="" required>
                    </div>
                </div>
