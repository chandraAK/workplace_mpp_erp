<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Submit Requirement From Party Form</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            Submit Requirement From Party Form
            </header>
            ...
            ?>
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/projectsc/proj_srp_entry">
                <?php
                    if($mr_id != ''){
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="submit" class="form-control" id="submit" name="submit" value="Submit Requirement From Party">
                    </div>
                    <div class="col-sm-4"></div>
                </div>
            </form>
