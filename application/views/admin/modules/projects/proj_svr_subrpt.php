<section id="main-content">
  <section class="wrapper"> 
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-laptop"></i>Submit Visit Form</h3>
    ...
    <div class="row" style="text-align:center">
        ...
        <section class="panel">
            ...
            ?>
            <form class="form-horizontal " method="post" action="<?php echo base_url(); ?>index.php/projectsc/proj_svr_subrpt_entry">
                <?php
                    if($visit_id != ''){
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="visit_asg_to" name="visit_asg_to" 
                        value="<?php if($visit_id != ''){ echo $visit_asg_to; } else { echo ""; }?>" required>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label">Visit Remarks</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="visit_rmks" name="visit_rmks" 
                        value="" required>
                    </div>
                </div>
